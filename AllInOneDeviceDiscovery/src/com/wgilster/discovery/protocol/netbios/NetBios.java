package com.wgilster.discovery.protocol.netbios;
...
public class NetBios implements Protocol {
	public static final int UDP_PORT_NAME_RESOLUTION = 137;
	public static final int UDP_PORT_COMMUNICATION = 138;
	...
	public static class CommunicationsListener implements NetworkListener {
		@Override
		public void networkEvent(NetworkTransport meta) {
			System.out.println("====");
			System.out.println("Source:" + meta.getRoute().getSourceAddress() +  ":" + meta.getRoute().getSourcePort());
	...
	public void bindToNetwork(Network network) throws IOException {
		...
		route.setSourcePort(UDP_PORT_NAME_RESOLUTION);
